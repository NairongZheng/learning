...
func (x *GetMinDisReq) GetPointList() []*Vector {
	if x != nil {
		return x.PointList
	}
	return nil
...
type GetMinDisRsp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MinDis        float32                `protobuf:"fixed32,1,opt,name=min_dis,json=minDis,proto3" json:"min_dis,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_grpc_test_proto_rawDesc = []byte{
	...
	,
...
var file_grpc_test_proto_goTypes = []any{
	...
	(*GetMinDisReq)(nil), // 1: grpc_test.GetMinDisReq
	(*GetMinDisRsp)(nil), // 2: grpc_test.GetMinDisRsp
}
var file_grpc_test_proto_depIdxs = []int32{
	0, // 0: grpc_test.GetMinDisReq.point_list:type_name -> grpc_test.Vector
	1, // 1: grpc_test.GetMimDisService.GetMinDis:input_type -> grpc_test.GetMinDisReq
	2, // 2: grpc_test.GetMimDisService.GetMinDis:output_type -> grpc_test.GetMinDisRsp

...
register_func = Register()  # from class_register import Register


# @register_func.register # 定义了__call__所以可以直接写成下面的形式
@register_func
def add(a : int, b : int):
    return a + b


# @register_func.register("my multiply")
@register_func("my multiply")
